...
@Component({
  ...
  styleUrls: ['./create-tournament-form.css'],
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, LucideAngularModule],
})
export class TournamentForm implements OnInit, OnChanges {
  @Input() tournament: Tournament | null = null; // For editing mode
  ...
  private initializeForm() {
    ...
    // Set banner preview if editing and tournament has banner
  ...
  onSubmit() {
    ...
    // Emit the tournament data to parent component
